...
async function POST(request) {
    ...
    try {
        ...
        // 1. Get current stock
        let ingredient = null;
        const ingredients = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT id, name, stock_quantity FROM ingredients WHERE id = ${ingredient_id} OR name = ${String(ingredient_id)} LIMIT 1`;
        ...
        if (user_id && !isNaN(Number(user_id))) {
            const userCheck = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT id FROM users WHERE id = ${Number(user_id)} LIMIT 1`;
            if (userCheck.length > 0) validUserId = userCheck[0].id;
        }
        if (!validUserId) {
            const fallback = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT id FROM users LIMIT 1`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c464c5f._.js.map