...
async function POST(request) {
    try {
        ...
        for (const item of items){
            const product = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$menu$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductById"])(item.product_id);
        ...
        for (const item of items){
            const deducted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$menu$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deductStock"])(item.product_id, item.quantity);
            if (!deducted) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            console.log(`[Stock] Deducted ${item.quantity} units of ${item.product_id} from memory. Remaining: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$menu$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductById"])(item.product_id)?.stock || 0}`);
        }
        try {
            ...
            if (validCashierId) {
                const cashierCheck = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
        ...
        `;
            ...
            if (!cashierExists) {
                ...
                const cashiers = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
      ...
      `;
            ...
            const insertedOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
            ...
            for (const item of items){
                ...
                try {
                    ...
                    if (!Number.isNaN(Number(item.product_id))) {
                        const byId = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT id, name, stock_quantity FROM products WHERE id = ${Number(item.product_id)}`;
                        if (byId.length > 0) dbProduct = byId[0];
                    }
                    // fallback: try by name
                    if (!dbProduct) {
                        const byName = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT id, name, stock_quantity FROM products WHERE name = ${baseName} LIMIT 1`;
