...
async function GET(request) {
    try {
        ...
        if (category) {
            const products = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT * FROM products WHERE is_active = true AND category = ${category} ORDER BY name`;
            return __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(products);
        } else {
            const products = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT * FROM products WHERE is_active = true ORDER BY name`;
            return __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(products);
        }
    } catch (error) {
...
async function POST(request) {
    ...
    `;
        ...
        try {
            if (result.length > 0) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$menu$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setStockByName"])(result[0].name, result[0].stock_quantity);
            }
        } catch (e) {
            console.warn("[Products] Failed to sync in-memory menu-data after product create", e);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(result[0], {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4a5b5b1._.js.map