...
async function POST(request) {
    try {
        ...
        if (user_id) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`INSERT INTO activity_logs (user_id, action, action_type, entity_type, entity_id, details) VALUES (${user_id}, 'Logged out', 'logout', 'User', ${user_id}, ${JSON.stringify({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__922e1e2b._.js.map