...
"[project]/sodalicious/app/api/reports/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
      ...
      WHERE ${whereClause}
    `;
        const totalsRes = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]([
            totalsQuery
        ]);
      ...
      LIMIT 10
    `;
        const topProducts = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]([
            topQuery
        ]);
    ...
    `;
        const breakdown = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]([
            breakdownQuery
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11877ff6._.js.map