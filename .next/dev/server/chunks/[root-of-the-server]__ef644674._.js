...
async function POST(request) {
    try {
        ...
        if (!Number.isNaN(Number(product_id))) {
            const byId = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT id, name, stock_quantity FROM products WHERE id = ${Number(product_id)}`;
            if (byId.length > 0) productResult = byId;
        }
        // Fallback: try string ID as product name (menu items like "Americano")
        if (productResult.length === 0) {
            const byName = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT id, name, stock_quantity FROM products WHERE name = ${String(product_id)} LIMIT 1`;
        ...
        // Update stock in DB
        await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`UPDATE products SET stock_quantity = ${newQuantity} WHERE id = ${productResult[0].id}`;
    ...
    `;
        ...
        if (Array.isArray(insertResult) && insertResult.length > 0) {
            ...
            const sel = await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`SELECT il.*, p.name as product_name, u.name as user_name FROM inventory_logs il LEFT JOIN products p ON il.product_id = p.id LEFT JOIN users u ON il.user_id = u.id WHERE il.id = ${insertResult.insertId} LIMIT 1`;
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$menu$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["changeStockByName"])(baseName, quantity_changed);
        } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ef644674._.js.map