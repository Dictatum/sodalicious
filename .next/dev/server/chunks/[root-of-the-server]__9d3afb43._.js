...
"[project]/sodalicious/app/api/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
      ...
      `;
            if (result.length > 0) {
                ...
                if (password === "123456") {
                    // Log login activity
                    try {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`INSERT INTO activity_logs (user_id, action, action_type, entity_type, entity_id, details) VALUES (${user.id}, 'Logged in', 'login', 'User', ${user.id}, 'User logged into the system')`;
                    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d3afb43._.js.map