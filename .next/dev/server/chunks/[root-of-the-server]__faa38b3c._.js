...
"[project]/sodalicious/app/api/auth/logout/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (user_id) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$sodalicious$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`INSERT INTO activity_logs (user_id, action, action_type, entity_type, entity_id, details) VALUES (${user_id}, 'Logged out', 'logout', 'User', ${user_id}, 'User logged out')`;
            } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__faa38b3c._.js.map